        ...
        <div className="lg:w-[40%] p-12 flex flex-col justify-between border-l border-nike-gray">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3 pt-4">
              ...
              <AnimatePresence>
                {addedToBag && (
                  <motion.button
                    ...
                    className="btn-bold w-full border-1.5 transition-colors flex items-center justify-center gap-2 bg-[#e2136e] text-white border-[#e2136e] hover:bg-[#c4115f] hover:border-[#c4115f] shadow-lg shadow-[#e2136e]/30"
                  >
              ...
              {/* Customer Care */}
              <a
                href="https://wa.me/8801922160036?text=Hi%2C%20I%20need%20help%20with%20an%20order."
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 text-xs font-bold text-nike-black/50 hover:text-[#25D366] transition-colors py-2 uppercase tracking-widest"
              >
